...
namespace ConsoleBlackJack
{
    ...
    {
        internal static CardService _cardService = new CardService();
        internal static MoneyService _moneyOp = new MoneyService();
